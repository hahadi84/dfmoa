    ...
    <section className="page-section is-tight">
      <div className="container">
        ...
        <article className="surface-card policy-article">
          ...
          <section>
            <h2>쿠키와 분석 도구</h2>
            <p>DFMOA는 사용자 경험 개선과 서비스 품질 분석을 위해 다음 쿠키를 사용합니다.</p>
            <ul>
              <li>Google Analytics 4 (측정 ID: G-SRSWS2FHS2) — 방문자 수, 유입 경로, 사이트 내 이동 분석</li>
              <li>향후 Google AdSense — 광고 승인 시 맞춤형 광고 쿠키 사용 예정</li>
            </ul>
            <p>
              사용자는 브라우저 설정에서 쿠키를 차단하거나, Google 광고 설정에서 맞춤형 광고를 해제할 수 있습니다.
              이벤트 측정에는 이메일, 전화번호, 토큰, 사용자 식별자 같은 개인정보를 넣지 않는 것을 원칙으로 합니다.
            </p>
          </section>
