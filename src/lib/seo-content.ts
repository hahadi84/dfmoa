...
export const brandLandings: BrandLanding[] = [
  ...
  },
  {
    ...
    categoryIds: ["beauty"],
    representativeProductIds: representativeProducts(["sk-ii-facial-treatment-essence-230ml"], "beauty", "SK-II"),
    relatedGuideSlugs: ["price-comparison-checklist"],
    relatedDealSlugs: ["2026-04"],
    updatedAt: UPDATED_AT,
  },
...
export const airportGuides: AirportGuide[] = [
  ...
  },
  {
    ...
    relatedProductIds: idsFromSlugs(["jo-malone-english-pear-100ml", "sk-ii-facial-treatment-essence-230ml"]),
    relatedGuideSlugs: ["pickup-and-limit-guide"],
    updatedAt: UPDATED_AT,
  },
  {
...
export const comparePages: ProductComparePage[] = [
  ...
  },
  {
    ...
    productIds: idsFromSlugs(["sulwhasoo-first-care-serum-90ml", "sk-ii-facial-treatment-essence-230ml"]),
    categoryId: "beauty",
